...
export const fallbackContent: SiteContent = {
  ...
  about: {
    ...
    body: ptList([
      ...
      'At Olsson I work directly with **many telecom and infrastructure clients**, delivering GIS tools, network design support, and spatial analysis. Across the fiber lifecycle I build bore profile automation (**days to minutes**), an ArcGIS Automation Suite for pocketing, conduit drawing, centerlines, and cable consolidation, FTTH network design add-ins, RF planning panels, and Fiber Automatic Expansion — a density-grouping build-area planner **used across multiple clients**.',
      'My ArcGIS Pro add-ins are adopted beyond one-off projects: the multi-source GIS Data Downloader is used **firm-wide** across projects and teams, alongside Street View, RF Analysis, and related utilities. I also learned **iBwave** to deliver DAS (distributed antenna system) designs, expanding from GIS automation into wireless engineering deliverables.',
      "A major thread of my work is applied AI for real bottlenecks. Using Azure AI Foundry, Azure OpenAI, and Google AI Studio, I built RFP Radar for intelligent contract sourcing (**months to hours**), plus YOLO-based object detection for remote utility inventory from aerial and street-level imagery. I was a **2025 Edison Award Nominee** and **2026 Edison Award Winner** at Olsson for these contributions.",
  ...
  jobs: [
    {
      ...
      bullets: ptList([
        ...
        'Shipped ArcGIS Pro add-ins (.NET/C#/WPF) adopted across projects and teams: GIS Data Downloader used **firm-wide**, FTTH Network Designer, Fiber Automatic Expansion (density grouping used across **multiple clients**), RF Analysis panel, and Street View tool.',
        ...
        'Built AI tools with Azure OpenAI and Google AI Studio — including RFP Radar — cutting contract sourcing from **months to hours**; plus YOLO apps for remote utility infrastructure inventory.',
