...
function showGameOver() {
  ...
  // Medal
  if      (score >= 30) medalDisplay.textContent = '🏅 GOLD';
  else if (score >= 20) medalDisplay.textContent = '🥈 SILVER';
  else if (score >= 10) medalDisplay.textContent = '🥉 BRONZE';
  else                  medalDisplay.textContent = '';
