...
import { UNIVERSE_IDS, universeMeta, type UniverseSelection } from './universe';

import styles from './StockScreener.module.css';



const UNIVERSE_TABS: { id: UniverseSelection; label: string }[] = [

  ...UNIVERSE_IDS.map(id => ({ id, label: universeMeta(id).shortLabel })),
      ...
      <div className={styles.viewModeTabs} role="tablist">
        ...
        {UNIVERSE_TABS.map(tab => (
          ...
          <button
            ...
            aria-selected={viewMode === 'universe' && universeSelection === tab.id}

            className={`${styles.viewModeTab} ${viewMode === 'universe' && universeSelection === tab.id ? styles.viewModeTabOn : ''}`}

            onClick={() => {

              onUniverseSelectionChange(tab.id);
